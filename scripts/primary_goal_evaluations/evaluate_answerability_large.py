"""
Direct Answerability Classification Evaluation — FLAN-T5-large

Pipeline per sample:
  masked instruction → FLAN-T5-large → predicted label
...
Output: reports/llm_audits/LLM_ANSWERABILITY_RESULTS_LARGE.parquet
...
def run_evaluation(input_path: str,
                   ...
                   output_filename: str = "LLM_ANSWERABILITY_RESULTS_LARGE.parquet",
                   batch_size: int = 16,
                   limit: int = None):
...
if __name__ == "__main__":
    ...
    if os.path.exists(DEGRADATION_PATH):
        run_evaluation(
            ...
            output_filename="LLM_ANSWERABILITY_RESULTS_LARGE.parquet",
            batch_size=8,
