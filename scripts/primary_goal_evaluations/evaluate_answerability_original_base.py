...
Evaluates FLAN-T5-base on original RVS instructions labeled under
...
def run_evaluation(input_path, model_name="google/flan-t5-base",
                   output_filename="LLM_ANSWERABILITY_RESULTS_ORIGINAL_BASE.parquet",
                   batch_size=8):
