...
#SBATCH --output=logs/answerability_olmo_shuf_%j.out
#SBATCH --error=logs/answerability_olmo_shuf_%j.err

echo "Starting Answerability Classification — OLMo-2-0425-1B-Instruct (Shuffled 4-Shot)"
echo "Date: $(date)"
echo "Node: $(hostname)"
...
python scripts/primary_goal_evaluations/olmo/evaluate_answerability_olmo_shuf.py
