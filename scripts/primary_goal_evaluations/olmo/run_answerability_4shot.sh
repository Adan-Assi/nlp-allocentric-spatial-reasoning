...
#SBATCH --output=logs/answerability_olmo_%j.out
#SBATCH --error=logs/answerability_olmo_%j.err

echo "Starting Answerability Classification — OLMo-2-0425-1B-Instruct"
echo "Date: $(date)"
echo "Node: $(hostname)"
...
python scripts/primary_goal_evaluations/olmo/evaluate_answerability_olmo_4shot.py
